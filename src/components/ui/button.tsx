...
const buttonVariants = cva(
	" w-full h-10  inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm" +
		...
		"aria-invalid:border-destructive !bg-[var(--default)]  !px-5 !py-2 cursor-pointer",
	{
		variants: {
			variant: {
