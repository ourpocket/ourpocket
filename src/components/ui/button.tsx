...
const buttonVariants = cva(
	"   h-10  inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm" +
		...
		"aria-invalid:border-destructive bg-[var(--default)]   !py-2 cursor-pointer",
	{
		variants: {
			variant: {
				default: "bg-[var(--default)] text-primary-foreground shadow-xs hover:bg-primary/90",
				destructive:
				...
				sleep: "bg-card text-primary-foreground shadow-xs hover:bg-primary/90",
			},
			size: {
